...
def generate_dataset(setting, n, cor=0.0, seed=0):
    ...
    if setting == "gaussian_quad":
    ...
    elif setting == "hd_interaction_sparse":
        ...
        true_idx = np.array([
            3, 11, 18, 27, 35, 44, 52, 61, 73, 81,
            94, 103, 117, 126, 138, 149, 157, 166, 179, 187,
            196, 207, 219, 228, 237, 249, 258, 271, 283, 291,
            304, 313, 327, 339, 348, 357, 369, 381, 394, 403,
            416, 427, 439, 451, 462, 474, 481, 488, 494, 499
        ])
